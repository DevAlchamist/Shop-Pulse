...
exports.sendMail = async function ({ to, subject, html, text }) {
  const info = await transporter.sendMail({
    from: '"Ecommerce" <nayakshubhanshu060705@gmail.com>', // sender address
              ...
              <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    ...
                    <td align="left" bgcolor="#D2C7BA" width="10%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>${
                      order._id
                    }</strong></td>
